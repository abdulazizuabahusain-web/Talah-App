...
import { ADMIN_PIN_HASH, GITHUB_PAT, PAT_EXPIRES_AT } from "../lib/config";
...
// ADMIN_PIN_HASH is a bcrypt hash of the admin PIN stored in env.
...
const PAT_EXPIRES_AT_RAW = PAT_EXPIRES_AT ?? "1970-01-01";
