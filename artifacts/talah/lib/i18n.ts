...
export const STRINGS: Dict = {
  ...
  city_select_placeholder: { ar: "اختاري المدينة", en: "Select your city" },

  survey_thanks: { ar: "شكراً لمشاركتك", en: "Thanks for sharing" },
  micro_survey_title: { ar: "سؤال سريع", en: "Quick question" },
  micro_q_source: {
    ar: "كيف سمعت عن طلعة؟",
    en: "How did you hear about Tal'ah?",
  },
  micro_q_expectation: {
    ar: "ما أكثر شيء تتطلعين إليه؟",
    en: "What are you most looking forward to?",
  },
  micro_q_word: {
    ar: "كلمة واحدة تصف ما تتمنينه من طلعة",
    en: "One word to describe what you hope Tal'ah will be for you",
  },
  micro_word_placeholder: { ar: "مثلاً: صحبة", en: "e.g. connection" },
  survey_source_friend: { ar: "صديقة", en: "Friend" },
  survey_source_instagram: { ar: "إنستغرام", en: "Instagram" },
  survey_source_tiktok: { ar: "تيك توك", en: "TikTok" },
  survey_source_whatsapp: { ar: "واتساب", en: "WhatsApp" },
  survey_source_other: { ar: "أخرى", en: "Other" },
  survey_expect_new_people: { ar: "لقاء أشخاص جدد", en: "Meeting new people" },
  survey_expect_dining: { ar: "تجارب المطاعم", en: "Dining experiences" },
  survey_expect_meaningful: {
    ar: "محادثات ذات معنى",
    en: "Meaningful conversations",
  },
  survey_expect_all: { ar: "كل شيء", en: "All of it" },
  exit_survey_title: { ar: "قبل أن تغادري", en: "Before you go" },
  exit_survey_subtitle: {
    ar: "رأيك يساعدنا على تحسين طلعة. يستغرق ٢٠ ثانية وهو مجهول.",
    en: "Your feedback helps us improve Tal'ah. It takes 20 seconds and is anonymous.",
  },
  exit_q_reason: { ar: "لماذا تغادرين؟", en: "Why are you leaving?" },
  exit_q_comment: { ar: "أي ملاحظات أخيرة؟", en: "Any last thoughts?" },
  exit_comment_placeholder: {
    ar: "اكتبي ملاحظتك هنا",
    en: "Share your thoughts",
  },
  exit_submit_continue: { ar: "أرسل وتابع", en: "Submit & Continue" },
  exit_reason_limited_cities: {
    ar: "المناطق المتاحة محدودة",
    en: "Limited cities available",
  },
  exit_reason_groups_not_fit: {
    ar: "المجموعات لم تناسبني",
    en: "Groups were not the right fit",
  },
  exit_reason_privacy: { ar: "مخاوف الخصوصية", en: "Privacy concerns" },
  exit_reason_taking_break: { ar: "أخذ استراحة", en: "Taking a break" },
  exit_reason_other: { ar: "أخرى", en: "Other" },
